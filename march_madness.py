            ...
            if _recap_sub == "highlights":
                ...
                for _hi, _hs in enumerate(_hist_top10, 1):
                    ...
                    _hist_rows_html += (
                        ...
                        f'<div style="text-align:center;font-size:11px;color:#9ca3af;">{_top_pct_display}%</div>'
                ...
                if user_name and user_name not in _hist_top10_names:
                    ...
                    if _viewer_entries:
                        ...
                        _viewer_row_html  = (
                            ...
                            f'<div style="text-align:center;font-size:11px;color:#9ca3af;">{_v_top_pct}%</div>'
                ...
                _s_hist = (
                    ...
                    f'<div style="font-size:10px;color:#6b7280;text-transform:uppercase;text-align:center;">Avg Rank %</div>'
